...
CSRF_TRUSTED_ORIGINS = ['https://kushnir.medblogers-base.ru', 'http://127.0.0.1']

ALLOWED_HOSTS = ["kushnir.medblogers-base.ru", "127.0.0.1", "localhost"]
...
ROOT_URLCONF = 'kushnir_forms.urls'
...
WSGI_APPLICATION = 'kushnir_forms.wsgi.application'
